...
By Stefan Gustavson, Linköping University, Sweden (stegu@itn.liu.se), 2005-03-22
*/
using UnityEngine;

public static class SimplexNoise {

    private readonly static int[][] grad3 = {
        new int[]{1,1,0}, new int[]{-1,1,0}, new int[]{1,-1,0}, new int[]{-1,-1,0},
        new int[]{1,0,1}, new int[]{-1,0,1}, new int[]{1,0,-1}, new int[]{-1,0,-1},
        new int[]{0,1,1}, new int[]{0,-1,1}, new int[]{0,1,-1}, new int[]{0,-1,-1}
    };

    private readonly static int[] perm = {
    ...
    // 3D simplex noise
    public static float Evaluate(float xin, float yin, float zin) {
        ...
        float G3 = 1f / 6f; // Very nice and simple unskew factor, too
        float t = (i + j + k) * G3;
        ...
        float y1 = y0 - j1 + G3;
        float z1 = z0 - k1 + G3;
        float x2 = x0 - i2 + 2f * G3; // Offsets for third corner in (x,y,z) coords
        float y2 = y0 - j2 + 2f * G3;
        float z2 = z0 - k2 + 2f * G3;
        float x3 = x0 - 1f + 3f * G3; // Offsets for last corner in (x,y,z) coords
